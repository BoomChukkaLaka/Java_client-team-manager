...
public class QuizViewController implements ChatClient {
  ...
  private HashMap<String,String> data=new HashMap<>();
    ...
    public void saveToHash(ActionEvent actionEvent) {
        String binArea=treeTArea.getText();
        String binStripped=binArea.replaceAll("IN-ORDER:","");
        String[] strings=binStripped.split(",");
        for (String str:strings){
            String [] topic=str.split("-");
            data.put(topic[0],topic[1]);
        }
        File file = new File("/Users/apple/Desktop/DataHash.txt");
        ...
        try {
            ...
            // iterating  hashmap entries using map
            for (Map.Entry<String, String> entry :
                    data.entrySet()) {

                //  key and value are separated by a colon to distinguish
    ...
    void handleCloseAction(ActionEvent event) {
       ...
       //stop();
        ...
        promptController.getStage("Prompt.fxml");
    }
